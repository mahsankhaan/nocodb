...
function build_image() {
    # build container image
     ...
     buildah --storage-driver=overlay tag nocodb-runner-new-image selfhosted.jfrog.io/nocodb-deps/nocodb-runner-image:0.2
     buildah --storage-driver=overlay --creds tekton:Tekton123@ push selfhosted.jfrog.io/nocodb-deps/nocodb-runner-image:0.2
}
